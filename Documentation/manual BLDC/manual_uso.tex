...
\chapter{Implementação}
    ...
    \section{Bloco BLDC}
        ...
        \textbf{Atenção:} desde a adição do modelo de atrito de Coulomb, esse bloco não suporta mais simulação com fixed-step solvers. Caso um fixed-step solver seja utilizado, o simulador apresentará comportamento anormal.
        \begin{figure}[ht]
            \centering
