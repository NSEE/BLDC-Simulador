...
static void sf_c1_untitled(SFc1_untitledInstanceStruct *chartInstance)
{
  ...
  c1_c_a = c1_b_a;
  c1_ak = c1_c_a;
  c1_y = muDoubleScalarPower(c1_ak, 2.0);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -4);
...
const mxArray *sf_c1_untitled_get_eml_resolved_functions_info(void)
{
  ...
  (*c1_b_info)[0].fileTimeLo = 1286836842U;
  ...
  (*c1_b_info)[1].fileTimeLo = 1336540096U;
  ...
  (*c1_b_info)[2].fileTimeLo = 1286836796U;
  ...
  (*c1_b_info)[3].fileTimeLo = 1330622834U;
  ...
  (*c1_b_info)[4].fileTimeLo = 1286836742U;
  ...
  (*c1_b_info)[5].fileTimeLo = 1286836726U;
...
static const mxArray *sf_get_sim_state_info_c1_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_untitled\",}}"
  };
