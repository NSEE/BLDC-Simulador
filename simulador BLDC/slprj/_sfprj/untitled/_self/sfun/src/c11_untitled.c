...
static const mxArray *sf_get_sim_state_info_c11_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[10],T\"x_hat\",},{M[1],M[11],T\"y_hat\",},{M[4],M[0],T\"C\",S'l','i','p'{{M1x2[118 119],M[0],}}},{M[4],M[0],T\"D\",S'l','i','p'{{M1x2[136 137],M[0],}}},{M[4],M[0],T\"t\",S'l','i','p'{{M1x2[100 101],M[0],}}},{M[4],M[0],T\"x\",S'l','i','p'{{M1x2[82 83],M[0],}}},{M[8],M[0],T\"is_active_c11_untitled\",}}"
  };
