...
static void c8_update_debugger_state_c8_untitled(SFc8_untitledInstanceStruct
  *chartInstance);
...
static void set_sim_state_c8_untitled(SFc8_untitledInstanceStruct *chartInstance,
  const mxArray *c8_st);
static void finalize_c8_untitled(SFc8_untitledInstanceStruct *chartInstance);
static void sf_c8_untitled(SFc8_untitledInstanceStruct *chartInstance);
static void initSimStructsc8_untitled(SFc8_untitledInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_untitledInstanceStruct *chartInstance,
  const mxArray *c8_C, const char_T *c8_identifier, real_T c8_y[2]);
static void c8_b_emlrt_marshallIn(SFc8_untitledInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[2]);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_untitledInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_d_emlrt_marshallIn(SFc8_untitledInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_e_emlrt_marshallIn(SFc8_untitledInstanceStruct *chartInstance,
  const mxArray *c8_b_is_active_c8_untitled, const char_T *c8_identifier);
static uint8_T c8_f_emlrt_marshallIn(SFc8_untitledInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static void initialize_c8_untitled(SFc8_untitledInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_untitled = 0U;
}
  ...
  *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_untitled;
  ...
  const mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_untitled = c8_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 1)), "is_active_c8_untitled");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_untitled(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  chartInstance = (SFc8_untitledInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c8_b_is_active_c8_untitled, const char_T *c8_identifier)
{
  ...
  c8_y = c8_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_untitled), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_untitled);
  return c8_y;
}
...
mxArray *sf_c8_untitled_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"C\",},{M[8],M[0],T\"is_active_c8_untitled\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_untitledInstanceStruct *chartInstance;
    chartInstance = (SFc8_untitledInstanceStruct *) ((ChartInfoStruct *)
...
{
  chart_debug_initialization(((SFc8_untitledInstanceStruct*) chartInstanceVar)
    ->S,0);
...
{
  sf_c8_untitled((SFc8_untitledInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_untitled(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_untitled((SFc8_untitledInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_untitled();/* state var info */
...
extern void sf_internal_set_sim_state_c8_untitled(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
...
{
  return sf_internal_get_sim_state_c8_untitled(S);
}

static void sf_opaque_set_sim_state_c8_untitled(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_untitled(S, st);
}

static void sf_opaque_terminate_c8_untitled(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c8_untitled((SFc8_untitledInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_untitled((SFc8_untitledInstanceStruct*) chartInstanceVar);
}
...
static void mdlStart_c8_untitled(SimStruct *S)
{
  SFc8_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc8_untitledInstanceStruct *)malloc(sizeof
  ...
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_untitled;
  ...
  chartInstance->chartInfo.mdlStart = mdlStart_c8_untitled;
