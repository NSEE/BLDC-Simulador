...
static void c6_update_debugger_state_c6_untitled(SFc6_untitledInstanceStruct
  *chartInstance);
...
static void set_sim_state_c6_untitled(SFc6_untitledInstanceStruct *chartInstance,
  const mxArray *c6_st);
static void finalize_c6_untitled(SFc6_untitledInstanceStruct *chartInstance);
static void sf_c6_untitled(SFc6_untitledInstanceStruct *chartInstance);
static void initSimStructsc6_untitled(SFc6_untitledInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_untitledInstanceStruct *chartInstance,
  const mxArray *c6_A, const char_T *c6_identifier, real_T c6_y[4]);
static void c6_b_emlrt_marshallIn(SFc6_untitledInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[4]);
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_untitledInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_d_emlrt_marshallIn(SFc6_untitledInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_e_emlrt_marshallIn(SFc6_untitledInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_untitled, const char_T *c6_identifier);
static uint8_T c6_f_emlrt_marshallIn(SFc6_untitledInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
...
static void initialize_c6_untitled(SFc6_untitledInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_untitled = 0U;
}
  ...
  *chartInstance)
{
  ...
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_untitled;
  ...
  const mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_untitled = c6_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 1)), "is_active_c6_untitled");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_untitled(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  chartInstance = (SFc6_untitledInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c6_b_is_active_c6_untitled, const char_T *c6_identifier)
{
  ...
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_untitled), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_untitled);
  return c6_y;
}
...
mxArray *sf_c6_untitled_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"A\",},{M[8],M[0],T\"is_active_c6_untitled\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_untitledInstanceStruct *chartInstance;
    chartInstance = (SFc6_untitledInstanceStruct *) ((ChartInfoStruct *)
...
{
  chart_debug_initialization(((SFc6_untitledInstanceStruct*) chartInstanceVar)
    ->S,0);
...
{
  sf_c6_untitled((SFc6_untitledInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_untitled(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_untitled((SFc6_untitledInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_untitled();/* state var info */
...
extern void sf_internal_set_sim_state_c6_untitled(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
...
{
  return sf_internal_get_sim_state_c6_untitled(S);
}

static void sf_opaque_set_sim_state_c6_untitled(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_untitled(S, st);
}

static void sf_opaque_terminate_c6_untitled(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c6_untitled((SFc6_untitledInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_untitled((SFc6_untitledInstanceStruct*) chartInstanceVar);
}
...
static void mdlStart_c6_untitled(SimStruct *S)
{
  SFc6_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc6_untitledInstanceStruct *)malloc(sizeof
  ...
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_untitled;
  ...
  chartInstance->chartInfo.mdlStart = mdlStart_c6_untitled;
