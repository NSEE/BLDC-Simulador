...
\begin{versionhistory}
  \vhEntry{0.0.1}{14.10.14}{Juliano Laganá}{Criação do documento}
\end{versionhistory}
...
\chapter{Introdução}
    ...
    \section{Hipóteses}
        \begin{itemize}
            ...
            \item O atrito no mancal é diretamente proporcional à velocidade angular do rotor em relação ao motor.
    ...
    \label{sec:modelo_matematico}
        ...
        \begin{description}
            ...
            \item[$\theta_m$] = Ângulo do rotor em relação ao motor
...
\chapter{Implementação}
    ...
    \section{Bloco BLDC}
        ...
        \begin{itemize}
            ...
            \item Saídas
            \begin{enumerate}
                \item Theta\_m - Ângulo entre o rotor e o motor ($\theta_m$) [rad]
                \item w\_m - Velocidade angular entre o rotor e o motor ($\frac{d\theta_m}{dt}$) [rad/s] 
